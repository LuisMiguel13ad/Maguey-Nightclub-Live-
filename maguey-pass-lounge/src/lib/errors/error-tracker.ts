 ...
 * Integrates with Sentry for external error monitoring.
 */

import { CapturedError, ErrorContext, ErrorSeverity, ErrorCategory, AppError } from './error-types';
import { captureError as sentryCaptureError, setUser as sentrySetUser, addBreadcrumb as sentryAddBreadcrumb } from '../sentry';
...
export const errorTracker = new ErrorTracker({
  serviceName: 'maguey-pass-lounge',

...
Plans:
- [ ] 21-01-PLAN.md — VIP floor plan drag-drop positioning (R26)
- [ ] 21-02-PLAN.md — VIP invite link sharing + VIP table sync logging (R27, R28)
- [ ] 21-03-PLAN.md — Remove hardcoded fallback events + SEO basics (R29, R30)

| Plan | Objective | Requirements | Wave |
|------|-----------|-------------|------|
| 21-01 | VIP floor plan drag-drop positioning with @dnd-kit/core | R26 | 1 |
| 21-02 | VIP invite link one-tap sharing + VIP table sync logging | R27, R28 | 1 |
| 21-03 | Remove hardcoded fallback events + sitemap/robots/JSON-LD | R29, R30 | 1 |
...
Plans:
- [ ] 23-01-PLAN.md -- Fix and enable GitHub Actions CI/CD pipeline (lint, test, build, E2E)
- [ ] 23-02-PLAN.md -- Switch Stripe to production keys and verify payment processing
- [ ] 23-03-PLAN.md -- Set Supabase/Vercel env vars, clean vercel.json, deploy all 3 sites

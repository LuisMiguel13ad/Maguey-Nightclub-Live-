...
| 15 | Auth Hardening & Login Flows | 3 | P0 | 2 days | Not Started |
| 16 | Route Protection | 2 | P0 | 1.5 days | Not Started |
| 17 | Security Lockdown | 4 | P0 | 2 days | Not Started |
| 18 | Scanner Improvements | 4 | P1 | 2 days | Not Started |
| 19 | Dashboard Data Accuracy | 4 | P1 | 2 days | Not Started |
...
**Total:** 36 plans across 10 phases (~12 working days)
...
| 17-04 | Reject unsigned QR codes in scanner | R23 | 1 |
...
| Plan | Objective | Requirements | Wave |
|------|-----------|-------------|------|
| 19-01 | Calculate real revenue trend percentages | R13 | 1 |
| 19-02 | Fix ticket_count and ticket_type on orders | R14, R15 | 1 |
| 19-03 | Display staff names instead of UUIDs | R16 | 1 |
| 19-04 | Optimize real-time subscriptions (targeted updates) | R17 | 2 |
...
| Plan | Objective | Requirements | Wave |
|------|-----------|-------------|------|
| 20-01 | Remove 5 monitoring pages from routes and sidebar | R39–R43 | 1 |
| 20-02 | Implement simplified sidebar structure | R44–R49 | 2 |
| 20-03 | Simplify Analytics, Fraud, Notifications | R18, R46–R48 | 1 |
| 20-04 | Assess/clean remaining bloat (NFC, ID, Override, Battery) | R50–R58 | 1 |

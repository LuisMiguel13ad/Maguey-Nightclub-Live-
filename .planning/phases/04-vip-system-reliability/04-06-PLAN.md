...
<task type="auto">
  <name>Task 2: Create increment_vip_checked_in RPC migration</name>
  <files>maguey-pass-lounge/supabase/migrations/20260130300000_vip_increment_checked_in.sql</files>
  <action>
Create a NEW migration file (not modifying 04-02's migration since it will already be applied).
...
test -f maguey-pass-lounge/supabase/migrations/20260130300000_vip_increment_checked_in.sql && echo "Migration file exists"
...
```
  ...
  <done>
New migration 20260130300000_vip_increment_checked_in.sql created. Function exists for updating VIP reservation when linked ticket scans.
  </done>
</task>

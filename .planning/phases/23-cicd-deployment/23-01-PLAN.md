...
```
Verify maguey-nights build step:
```bash
grep "maguey-nights" .github/workflows/e2e.yml
```
Verify container 1 no longer runs happy-path:
```bash
grep -A2 "containers == 1" .github/workflows/e2e.yml
```
  </verify>
  <done>

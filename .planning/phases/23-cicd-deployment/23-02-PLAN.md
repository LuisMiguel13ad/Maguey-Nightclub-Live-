...
NOTE: The `vip/webhook` Edge Function was removed in Phase 13 (Plan 13-02). All Stripe events (GA and VIP) route through the single `stripe-webhook` function. Only one production webhook endpoint is needed.
  </action>
  <verify>

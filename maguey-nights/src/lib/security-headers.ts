 ...
 * 
 * Customized for maguey-nights marketing site with analytics and external content support.
 * 
 * @example
 * ```typescript
...
// ============================================
// PRE-CONFIGURED HEADERS FOR MARKETING SITE
// ============================================

/**
 * Pre-configured security headers for maguey-nights marketing site
 * 
 * Includes marketing site requirements:
 * - Google Analytics support
 * - External images from any HTTPS source
...
export const securityHeaders = getSecurityHeaders({
  contentSecurityPolicy: [
    ...
    "connect-src 'self' https://www.google-analytics.com https://*.google-analytics.com https://*.supabase.co wss://*.supabase.co",

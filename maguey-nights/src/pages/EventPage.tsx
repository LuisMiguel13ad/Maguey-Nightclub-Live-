...
const EventPage = () => {
  ...
  // Fallback hardcoded events for backward compatibility (if needed)
  const fallbackEvents = {
    "bad-bunny-night": {
      image: eventReggaeton,
      artist: "BAD BUNNY NIGHT",
      date: "OCT 25 FRIDAY",
      time: "10:00 PM - 3:00 AM",
      price: "$50 - $100",
      description: "Experience the ultimate Bad Bunny night featuring his biggest hits and latest tracks. Dance to 'Tití Me Preguntó', 'Me Porto Bonito', and all your favorite reggaeton anthems.",
      features: ["Bad Bunny Hits", "VIP Tables Available", "Bottle Service", "21+ Only"],
      venue: "MAGUEY DELAWARE",
      address: "123 Main Street, Delaware"
    },
    "banda-el-recodo-live": {
      image: eventFiesta,
      artist: "BANDA EL RECODO LIVE",
      date: "OCT 26 SATURDAY",
      time: "9:00 PM - 2:00 AM",
      price: "$75 - $150",
      description: "Legendary Banda El Recodo brings their authentic Mexican banda sound to Maguey. Experience the power of traditional banda music with live horns, percussion, and vocals.",
      features: ["Live Banda Performance", "Traditional Instruments", "Authentic Mexican Culture", "21+ Only"],
      venue: "MAGUEY DELAWARE",
      address: "123 Main Street, Delaware"
    },
    "cumbia-kings": {
      image: venueMainstage,
      artist: "CUMBIA KINGS",
      date: "OCT 27 SUNDAY",
      time: "8:00 PM - 1:00 AM",
      price: "$25 - $50",
      description: "The ultimate cumbia experience featuring the best cumbia artists and DJs. From classic cumbia to modern cumbia villera, dance the night away to infectious Latin rhythms.",
      features: ["Classic & Modern Cumbia", "Dance Floor", "Family Friendly", "All Ages Welcome"],
      venue: "MAGUEY DELAWARE",
      address: "123 Main Street, Delaware"
    },
    "j-balvin-special": {
      image: eventChampagne,
      artist: "J BALVIN SPECIAL",
      date: "NOV 1 FRIDAY",
      time: "10:00 PM - 3:00 AM",
      price: "$60 - $120",
      description: "Special J Balvin night featuring his chart-topping hits and reggaeton classics. Experience 'Mi Gente', 'Con Altura', and the best of Colombian reggaeton.",
      features: ["J Balvin Hits", "VIP Meet & Greet", "Exclusive Performance", "21+ Only"],
      venue: "MAGUEY DELAWARE",
      address: "123 Main Street, Delaware"
    },
    "los-tigres-del-norte": {
      ...
      time: "9:00 PM - 2:00 AM",
      price: "$80 - $160",
      description: "Iconic norteño band Los Tigres del Norte brings their legendary corridos and norteño music to Maguey. Experience authentic Mexican regional music at its finest.",
      features: ["Live Norteño Performance", "Classic Corridos", "Cultural Experience", "21+ Only"],
      venue: "MAGUEY DELAWARE",
      address: "123 Main Street, Delaware"
    },
    "cumbia-villera-night": {
      image: venuePatio,
      artist: "CUMBIA VILLERA NIGHT",
      date: "NOV 3 SUNDAY",
      time: "8:00 PM - 1:00 AM",
      price: "$30 - $60",
      description: "Raw and energetic cumbia villera night featuring the most popular villera artists. Dance to the infectious beats that define Argentine cumbia culture.",
      features: ["Cumbia Villera Hits", "Live DJ Sets", "Dance Lessons", "All Ages Welcome"],
      venue: "MAGUEY DELAWARE",
      address: "123 Main Street, Delaware"
    },
    "karol-g-halloween": {
      image: social1,
      artist: "KAROL G HALLOWEEN",
      date: "NOV 8 FRIDAY",
      time: "10:00 PM - 3:00 AM",
      price: "$40 - $80",
      description: "Spooky Halloween night featuring Karol G's biggest hits with a Halloween twist. Dress up and dance to 'Tusa', 'Bichota', and more with special Halloween effects.",
      features: ["Karol G Hits", "Halloween Theme", "Costume Contest", "21+ Only"],
      venue: "MAGUEY DELAWARE",
      address: "123 Main Street, Delaware"
    },

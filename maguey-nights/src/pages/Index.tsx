...
const Index = () => {
  ...
  const socialPosts = [
    { image: social1, handle: "@magueynightclub" },
    { image: social2, handle: "@magueyvip" },
    { image: social3, handle: "@magueyafterdark" }
  ];
      ...
      <section className="py-20 px-4 bg-black">
        <div className="container mx-auto max-w-4xl text-center">
          <motion.h2 
            ...
            className="text-2xl md:text-4xl font-black text-center mb-6 tracking-wider text-white drop-shadow-[0_0_30px_rgba(57,181,74,0.5)] neon-magenta-static"
          >
        ...
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div className="mb-8 flex justify-center">
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1">
              ...
              <span className="text-xs uppercase tracking-[0.3em] font-semibold text-white/70 font-geist">
          ...
          <motion.h3
            ...
            className="text-center text-3xl md:text-5xl font-black tracking-tight text-white font-jakarta mb-4"
          >
            <span className="text-[#39B54A]">Maguey</span> Fan Stories
          </motion.h3>
          <p className="text-center text-white/70 max-w-2xl mx-auto font-geist mb-12">
            ...
            {fanTestimonials.map((testimonial) => (
              ...
              >
                <div className="relative z-10">
                  <div className="mb-3 text-3xl leading-none text-white font-jakarta">"</div>
                  <p className="text-base text-white/80 font-geist">{testimonial.quote}</p>
                  <div className="mt-5 flex items-center gap-3">
                    <div className="h-10 w-10 rounded-full bg-white/10" />
                    <div>
                      <div className="text-sm text-white font-geist font-semibold">{testimonial.name}</div>
                      <div className="text-xs text-white/60 font-geist">{testimonial.title}</div>
                    </div>
                  </div>
                </div>
              </article>
      ...
      <section className="bg-black">
         <div className="container mx-auto py-12">
          <motion.h2 
            ...
            className="text-xl md:text-2xl font-normal text-center mb-12 tracking-widest text-[#39B54A]" 
      ...
      <section className="py-20 px-4 bg-black">
        <div className="container mx-auto">
          <motion.h2 
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.6, ease: "easeOut" }}
            className="text-2xl md:text-4xl font-black text-center mb-12 tracking-wider text-white drop-shadow-[0_0_30px_rgba(57,181,74,0.5)] neon-cyan-static"
          >
            THEMED NIGHTS
          </motion.h2>
      ...
      <section className="py-20 px-4 bg-black">
        <div className="container mx-auto">
          <motion.h2 
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.6, ease: "easeOut" }}
            className="text-2xl md:text-4xl font-black text-center mb-12 tracking-wider text-white drop-shadow-[0_0_30px_rgba(57,181,74,0.5)] neon-red-static"
          >
            FOLLOW MAGUEY
          </motion.h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {socialPosts.map((post, index) => (
              <motion.div 
                ...
                className="relative group overflow-hidden rounded-2xl cursor-pointer bg-white/5 backdrop-blur-md border border-white/20 shadow-lg hover:shadow-2xl transition-all duration-500"
              >
                <div className="relative h-96">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent opacity-60 group-hover:opacity-80 transition-opacity rounded-t-2xl"></div>
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <p className="text-white font-semibold tracking-wider">{post.handle}</p>
                  </div>
                </div>
              </motion.div>
            ))}

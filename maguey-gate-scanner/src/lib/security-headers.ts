 ...
 * 
 * Customized for maguey-gate-scanner with camera and media access support.
 * 
 * @example
 * ```typescript
...
// ============================================
// PRE-CONFIGURED HEADERS FOR GATE-SCANNER
// ============================================

/**
 * Pre-configured security headers for maguey-gate-scanner
 * 
 * Includes scanner-specific requirements:
 * - Camera access for QR code scanning
 * - Blob URLs for camera/image data
 * - Media sources for video streams
 * - Less restrictive COEP/COOP for camera APIs
 * 
 * @example
 * ```typescript
 * // In Vite config
...
export const securityHeaders = getSecurityHeaders({
  ...
  strictTransportSecurity: 'max-age=31536000; includeSubDomains; preload',
  xXSSProtection: '1; mode=block',
  // Less restrictive for camera APIs
